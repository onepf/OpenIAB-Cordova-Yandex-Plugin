...
public class OpenIabCordovaPlugin extends CordovaPlugin
{
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException
    {
        if ("init".equals(action))
        {
            ...
            // The can be only one. Yandex MacLeod
            builder.addAvailableStoreNames(OpenIabHelper.NAME_YANDEX);
            builder.addPreferredStoreName(OpenIabHelper.NAME_YANDEX);
            
            if (publicKey != null && !publicKey.equals(""))
                builder.addStoreKey(OpenIabHelper.NAME_YANDEX, publicKey);
